...
void Laborator2::Init()
{
	...
	// Create a shader program for surface generation
	{
		...
		shader->AddShader("Source/Laboratoare/Laborator2/Shaders/GeometryShader2.glsl", GL_GEOMETRY_SHADER);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	glUniform1i(glGetUniformLocation(shader->program, "curve_type"), curve_type);
